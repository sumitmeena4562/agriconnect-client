...
const DashboardLayout = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, text: '🌾 New order request received!', time: 'Just now', read: false },
    { id: 2, text: 'Welcome to AgriConnect! Go to My Crops to add your listings.', time: '1 hr ago', read: false }
  ]);
